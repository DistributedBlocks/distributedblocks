...
type Config struct {
	...
	// Data directory holds app data -- defaults to ~/.distributedblocks
...
func (c *Config) register() {
	...
	flag.StringVar(&c.DataDirectory, "data-dir", c.DataDirectory, "directory to store app data (defaults to ~/.distributedblocks)")
	flag.StringVar(&c.DBPath, "db-path", c.DBPath, "path of database file (defaults to ~/.distributedblocks/data.db)")
	...
	flag.StringVar(&c.WalletDirectory, "wallet-dir", c.WalletDirectory, "location of the wallet files. Defaults to ~/.distributedblocks/wallet/")
...
var devConfig = Config{
	...
	PeerListURL:            "https://downloads.distributedblocks.net/blockchain/peers.txt",
	...
	LaunchBrowser: false,
	// Data directory holds app data -- defaults to ~/.distributedblocks
	DataDirectory: filepath.Join(home, ".distributedblocks"),
